const translations = {
  en: {
    ...
    "quick.copy": "Use pip install -e . from a checkout, then call tarot, I Ching, Xiao Liu Ren, or agent templates through ai-divination.",
  ...
  zh: {
    ...
    "quick.copy": "在 checkout 中使用 pip install -e .，之后通过 ai-divination 调用塔罗、易经、小六壬或 agent 解读模板。",
    "install.label": "安装",
  ...
  ja: {
    ...
    "quick.copy": "checkout で pip install -e . を実行すると、ai-divination からタロット、易経、小六壬、agent テンプレートを呼び出せます。",
