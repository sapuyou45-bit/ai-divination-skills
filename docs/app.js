const translations = {
  en: {
    ...
    "hero.copy":
      "Tarot, I Ching, Xiao Liu Ren, and Bazi skills that separate the divination process from interpretation. Scripts perform the draw or cast and emit JSON. AI only interprets.",
    ...
    "skills.title": "Four practical modules to start.",
    ...
    "skills.bazi.copy": "Cast four pillars, five elements, NaYin, and zodiac from a birth datetime.",
    "quick.label": "Quick start",
    "quick.title": "Install once, call one CLI.",
    "quick.copy": "Install with pip install oraclebone, then call tarot, I Ching, Xiao Liu Ren via ai-divination, or mount the built-in MCP server (ai-divination-mcp) in Claude Desktop / Codex.",
  ...
  zh: {
    ...
    "hero.copy":
      "塔罗、易经、小六壬、八字技能将占卜过程与解释分开：脚本负责抽取或起课并输出 JSON，AI 只负责解读。",
    ...
    "skills.bazi.copy": "由出生时间排出四柱、五行、纳音与生肖。",
    "quick.label": "快速开始",
    "quick.title": "安装一次，用一个 CLI 调用。",
    "quick.copy": "用 pip install oraclebone 安装，然后通过 ai-divination 调用塔罗、易经、小六壬，或在 Claude Desktop / Codex 里挂载内置的 MCP server (ai-divination-mcp)。",
    "install.label": "安装",
  ...
  ja: {
    ...
    "hero.copy":
      "タロット、易経、小六壬、四柱推命の skill は、占術プロセスと解釈を分離します。スクリプトが抽選や起卦を行って JSON を出力し、AI は解釈だけを担当します。",
    ...
    "skills.title": "まずは実用的な 4 つのモジュールから。",
    ...
    "skills.bazi.title": "四柱推命",
    "skills.bazi.copy": "生まれた日時から四柱・五行・納音・十二支を導出します。",
    "quick.label": "クイックスタート",
    "quick.title": "一度インストールして、1 つの CLI で呼び出します。",
    "quick.copy": "pip install oraclebone でインストールし、ai-divination からタロット・易経・小六壬を呼び出すか、Claude Desktop / Codex で内蔵 MCP サーバー (ai-divination-mcp) をマウントできます。",
    "install.label": "インストール",
    "install.title": "AI agent に 1 行貼り付けます。",
    "install.copy": "agent がリモートのインストール手順を読み、tarot、iching、xiaoliuren、bazi を skill ディレクトリへコピーし、スクリプトを検証します。",
