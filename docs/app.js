const translations = {
  en: {
    ...
    "quick.copy": "Core scripts use Python 3 and emit JSON. Optional lunar-time support can install lunar_python.",
  ...
  zh: {
    ...
    "quick.copy": "核心脚本使用 Python 3 并输出 JSON。可选的 lunar-time 支持可安装 lunar_python。",
    "install.label": "安装",
  ...
  ja: {
    ...
    "quick.copy": "コアスクリプトは Python 3 で動作し、JSON を出力します。任意の lunar-time サポートには lunar_python を追加できます。",
